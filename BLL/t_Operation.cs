...
namespace ZSystem.BLL
{
    ...
    /// 业务逻辑类 t_Operation
    /// </summary>
    public class t_Operation : BLHelper
    {
        private readonly ZSystem.DAL.t_Operation dal = new ZSystem.DAL.t_Operation();
        ...
        /// 增加一条数据
        /// </summary>
        public void Add(ZSystem.Model.t_Operation model)
        {
            dal.Add(model);
        }
        ...
        /// 更新一条数据
        /// </summary>
        public void Update(ZSystem.Model.t_Operation model)
        {
        ...
        {
            ZSystem.Model.t_Operation model = null;
            if (!EnableCache)
            {
            ...
            else
            {
                ...
                {
                    model = (ZSystem.Model.t_Operation)GetModelCache(key);
                }
                else
                {
                    model = dal.GetModel(KeyID);
