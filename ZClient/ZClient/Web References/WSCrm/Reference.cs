...
namespace ZClient.WSCrm {
    ...
    public partial class CrmService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetOperationStateListOperationCompleted;
        ...
        /// <remarks/>
        public event GetOperationStateListCompletedEventHandler GetOperationStateListCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://Zsystem.Info/GetOperationStateList", RequestNamespace="http://Zsystem.Info/", ResponseNamespace="http://Zsystem.Info/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public t_OperationState[] GetOperationStateList(string OperatorID) {
            object[] results = this.Invoke("GetOperationStateList", new object[] {
                        OperatorID});
            return ((t_OperationState[])(results[0]));
        }
        
        /// <remarks/>
        public void GetOperationStateListAsync(string OperatorID) {
            this.GetOperationStateListAsync(OperatorID, null);
        }
        
        /// <remarks/>
        public void GetOperationStateListAsync(string OperatorID, object userState) {
            if ((this.GetOperationStateListOperationCompleted == null)) {
                this.GetOperationStateListOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetOperationStateListOperationCompleted);
            }
            this.InvokeAsync("GetOperationStateList", new object[] {
                        OperatorID}, this.GetOperationStateListOperationCompleted, userState);
        }
        
        private void OnGetOperationStateListOperationCompleted(object arg) {
            if ((this.GetOperationStateListCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetOperationStateListCompleted(this, new GetOperationStateListCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    public delegate void GetOperationStateListCompletedEventHandler(object sender, GetOperationStateListCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetOperationStateListCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetOperationStateListCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public t_OperationState[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((t_OperationState[])(this.results[0]));
            }
        }
    }
