...
namespace ZClient.WSCrm {
    ...
    public partial class CrmService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public t_Operation[] GetOperationList() {
            object[] results = this.Invoke("GetOperationList", new object[0]);
            return ((t_Operation[])(results[0]));
        }
        
        /// <remarks/>
        public void GetOperationListAsync() {
            this.GetOperationListAsync(null);
        }
        
        /// <remarks/>
        public void GetOperationListAsync(object userState) {
            ...
            this.InvokeAsync("GetOperationList", new object[0], this.GetOperationListOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void GetOperationAsync(string KeyID) {
            this.GetOperationAsync(KeyID, null);
        }
        
        /// <remarks/>
        public void GetOperationAsync(string KeyID, object userState) {
            ...
            this.InvokeAsync("GetOperation", new object[] {
                        KeyID}, this.GetOperationOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void GetProductAsync(string KeyID) {
            this.GetProductAsync(KeyID, null);
        }
        
        /// <remarks/>
        public void GetProductAsync(string KeyID, object userState) {
            ...
            this.InvokeAsync("GetProduct", new object[] {
                        KeyID}, this.GetProductOperationCompleted, userState);
        }
        ...
        public t_Product[] GetProductList() {
