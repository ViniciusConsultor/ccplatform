...
namespace ZClient.WSMain {
    ...
    public partial class MainService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://Zsystem.Info/GetUserState", RequestNamespace="http://Zsystem.Info/", ResponseNamespace="http://Zsystem.Info/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public eSysUserState GetUserState(string UserID, string OperatorID) {
            object[] results = this.Invoke("GetUserState", new object[] {
                        UserID,
                        OperatorID});
            return ((eSysUserState)(results[0]));
        }
        
        /// <remarks/>
        public void GetUserStateAsync(string UserID, string OperatorID) {
            this.GetUserStateAsync(UserID, OperatorID, null);
        }
        
        /// <remarks/>
        public void GetUserStateAsync(string UserID, string OperatorID, object userState) {
            ...
            this.InvokeAsync("GetUserState", new object[] {
                        UserID,
                        OperatorID}, this.GetUserStateOperationCompleted, userState);
        }
    ...
    public partial class GetUserStateCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public eSysUserState Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((eSysUserState)(this.results[0]));
            }
        }
    }
}
