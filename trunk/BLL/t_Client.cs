...
namespace ZSystem.BLL
{
    ...
    /// 业务逻辑类 t_Client
    /// </summary>
    public class t_Client : BLHelper
    {
        private readonly ZSystem.DAL.t_Client dal = new ZSystem.DAL.t_Client();
        ...
        /// 增加一条数据
        /// </summary>
        public void Add(ZSystem.Model.t_Client model)
        {
            dal.Add(model);
        }
        ...
        /// 更新一条数据
        /// </summary>
        public void Update(ZSystem.Model.t_Client model)
        {
        ...
        {
            ZSystem.Model.t_Client model = null;
            if (!EnableCache)
            {
            ...
            else
            {
                ...
                {
                    model = (ZSystem.Model.t_Client)GetModelCache(key);
                }
                else
                {
                    model = dal.GetModel(KeyID);
