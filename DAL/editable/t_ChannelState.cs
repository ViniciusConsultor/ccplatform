...
{
    /// <summary>
    /// 数据访问类 t_ChannelState
    /// </summary>
    public partial class t_ChannelState : DALHelper
    {
        /// <summary>
        /// 增加一条数据
        /// </summary>
        public int Add(ZSystem.Model.t_ChannelState model)
        {
        ...
        public int GetCount()
        {
            object obj = dbHelper.ExecuteScalar(CommandType.Text, "SELECT count(*) FROM t_ChannelState", null);
        ...
        {
            StringBuilder strSql = new StringBuilder("SELECT * FROM t_ChannelState");
            using (DbDataReader dr = dbHelper.ExecuteReader(CommandType.Text, strSql.ToString(), null))
            {
                List<ZSystem.Model.t_ChannelState> lst = GetList(dr);
                return lst;
            }
        }
        ...
        public PageList<ZSystem.Model.t_ChannelState> GetPageList(PageInfo pi)
        {
            ...
            PageList<ZSystem.Model.t_ChannelState> pl = new PageList<ZSystem.Model.t_ChannelState>(pi);
            using (DbDataReader dr = dbHelper.ExecuteReader(CommandType.Text, "SELECT * FROM t_ChannelState", null))
            {
        ...
        /// </summary>
        private List<ZSystem.Model.t_ChannelState> GetList(DbDataReader dr)
        {
            List<ZSystem.Model.t_ChannelState> lst = new List<ZSystem.Model.t_ChannelState>();
            while (dr.Read())
            {
                lst.Add(GetModel(dr));
            }
        ...
        /// </summary>
        private List<ZSystem.Model.t_ChannelState> GetPageList(DbDataReader dr, int first, int count)
        {
            List<ZSystem.Model.t_ChannelState> lst = new List<ZSystem.Model.t_ChannelState>();
