...
namespace ZWebService.Logging
{
    ...
    {
        private static Category config = new Category("ZService.Config");
        private static Category httpModule = new Category("ZService.HttpModule");
        private static Category protocol = new Category("ZService.Protocol");
        private static Category security = new Category("ZService.Security");
