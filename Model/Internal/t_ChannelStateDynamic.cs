...
{
    /// <summary>
    /// 实体类 t_ChannelStateDynamic，此类请勿动，以方便表字段更改时重新生成覆盖
    /// </summary>
    [Serializable]
    public partial class t_ChannelStateDynamic : ICloneable
    {
        public t_ChannelStateDynamic()
        { }
        
        /// <summary>
        /// 构造函数 t_ChannelStateDynamic
        /// </summary>
        ...
        public t_ChannelStateDynamic(int? iChID, string sChState, int? iChType, string sCaller, string sDTMF, int? iTimeElapse)
        {
            this.iChID = iChID;
        ...
        {
            ZSystem.Model.t_ChannelStateDynamic model = obj as ZSystem.Model.t_ChannelStateDynamic;
